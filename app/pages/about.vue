      ...
      <v-col cols="12">
        ...
        <v-container>
          <v-row class="py-16">
            <v-col cols="12">
              <h2
                class="text-headline-large text-md-display-medium text-center font-weight-black text-capitalize"
              >
                Who we are?
              </h2>
              <h3
                class="text-headline-large text-uppercase font-weight-thin text-center my-8"
              >
            ...
            <v-col cols="12" md="6">
              ...
              <blockquote class="text-headline-large pa-5 my-4 font-weight-thin">
        ...
        <v-row no-gutters>
          ...
          <v-col cols="12" md="6" class="align-self-center">
            <div class="pa-lg-16 pa-md-10 px-4 py-16">
              <h2 class="text-display-medium text-center font-weight-black">Our Vision</h2>
              <h3
                class="text-headline-small text-uppercase font-weight-thin text-center my-8"
              >
                Lorem ipsum dolor sit amet, consectetur adipisicing elit
              </h3>
              <p>
        ...
        <v-row no-gutters class="flex-row-reverse">
          ...
          <v-col cols="12" md="6" class="align-self-center">
            <div class="pa-lg-16 pa-md-10 px-4 py-16">
              <h2 class="text-display-medium text-center font-weight-black">Our Mission</h2>
              <h3
                class="text-headline-small text-uppercase font-weight-thin text-center my-8"
              >
                Lorem ipsum dolor sit amet, consectetur adipisicing elit
